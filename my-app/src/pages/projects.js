            ...
            <div id="slides-container">
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/chef-boy0.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                    ...
                    <div className="interact-wrapper">
                        <a className="slide-interact" href="projects/chef-boy.html">More Info</a>
                ...
                <div className="slide">
                    ...
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/toony-wars0.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                    ...
                    <div className="interact-wrapper">
                        <a className="slide-interact" href="projects/toony-wars.html">More Info</a>
                ...
                <div className="slide">
                    ...
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/personal-website0.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/sorting-algorithm-visualiser.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/chef-boy-20.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/citation0.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/bio-spreadsheet-game0.png"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left " onClick="changeSlide(1)">&#10095;</button>
                    </div>
                ...
                <div className="slide">
                    <div className="slide-image-container">
                        <img className="slide-image" src="images/arduino0.jpg"></img>
                            <button className="slide-button button-right" onClick="changeSlide(-1)">&#10094;</button>
                            <button className="slide-button button-left" onClick="changeSlide(1)">&#10095;</button>
                    </div>
